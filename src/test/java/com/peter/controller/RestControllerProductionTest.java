...
public class RestControllerProductionTest {
    
    @InjectMocks
    private final RestControllersProduction restControllers;
    ...
    public RestControllerProductionTest() {
        restControllers= new RestControllersProduction();
    ...
    public void testAuthorizeWrongMessageBody() throws Exception {
        ...
        assertEquals(MockHttpServletResponse.SC_INTERNAL_SERVER_ERROR,result.getResponse().getStatus());
    }
...
//                    ).andReturn();
//        SoftAssertions assertion = new SoftAssertions();
//        assertion.assertThat(result.getResponse().getStatus()).isEqualTo(MockHttpServletResponse.SC_INTERNAL_SERVER_ERROR);
//        assertion.assertAll();
//    }
